...
```{python}
target_variables = pensions[['HHID', 'PN', 'SJ2W410', 'SJ2W411', 'SJ2W405', 'SJ2W407', 'SJ2W426', 'SJ2W009']]
target_variables = target_variables.rename(columns = {'SJ2W410': 'Year Job - Begin', 'SJ2W411' : 'Year Job - End', 'SJ2W405': 'Plan Provider', 'SJ2W407' : 'Type of Plan', 'SJ2W426' : 'Recieving Benefits', 'SJ2W009' : 'Amount in Pension Now'})
...
```{python}
retirment = pd.read_csv('../csv_files/h22j3_r.csv')
retirment_use = retirment[['HHID', 'PN', 'SJ3578']]
retirment_use['HHID'] = retirment_use['HHID'].astype(str)
retirment_use['PN'] = retirment_use['PN'].astype(str)
retirment_use['HHID + PN'] = retirment_use['HHID'] + retirment_use['PN']
retirment_use
```
