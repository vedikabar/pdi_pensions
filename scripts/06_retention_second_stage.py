...
readable["Interpretation"] = readable["term"].map({
    "const": "Average Illinois retention beta-hat before 2011",
    "post": "Average post-2011 shift in Illinois retention beta-hat",
})
...
plt.title("Event-study style plot: Illinois retention beta-hats by year pair")
plt.xlabel("Year pair midpoint")
plt.ylabel("Illinois coefficient on retention, percentage points")
